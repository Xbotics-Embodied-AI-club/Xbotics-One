...
POLICY_PATH = Path("5_2_ACT/outputs/act_libero_goal_plate_20260409_141037/checkpoints/000954/pretrained_model")
...
STRICT_LOAD = False
SAVE_VIDEO = True
VIDEO_PATH = Path("5_2_ACT/output/act_libero_rollout.mp4")
RESULT_PATH = Path("5_2_ACT/output/act_libero_rollout.json")
